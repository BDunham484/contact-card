...
//async export function that will create and insert data into the IndexedDB database
...
//async export function that will delete data from the indexedDB database
...
//exported async function that will user to update data
export const editDb = async (id, name, email, phone, profile) => {
    ...
    //create a new transaction and specify the store and data privileges.
    const tx = contactDb.transaction('contacts', 'readwrite');
    //ope up the desired object store.
    const store = tx.objectStore('contacts');
